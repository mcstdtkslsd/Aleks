    ...
    >
      ...
      {activeLocale == "zh" ? (
        ...
        <div className="flex flex-col gap-2">
          <div>我是一个热爱思考且富有韧性的人。</div>
          <div>
            在大学期间，我开始接触到建模，游戏开发，并逐渐喜欢上这些技能。
          </div>
          <div>
            在大三的暑假，我前往了德马科技股份有限公司的市场部实习，在那里，我进行了模型渲染、宣传海报制作和参与布展等工作，进一步丰富了自己的技能。
          </div>
          <div>
            在学校里，我也参加了许多游戏开发设计的项目，我使用这些技术也越来越熟练。
          </div>

          <div>
            目前，我在进行着新的项目开发，同时也积极地进行简历投递，在2026年毕业之后，我希望能找到一份满意的工作。
          </div>
        </div>
      ) : (
        <>
