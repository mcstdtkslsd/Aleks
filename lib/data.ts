...
export const experiencesData = [
    ...
    },
    {
        ...
        description: "Developed NIO's third-generation station list and detail pages using Vue3, TypeScript, and Baidu Maps API. Implemented role-based access control for the Task Wizard page, enhancing system security. Collaborated effectively within a Jira-managed environment, utilizing Jenkins for deployment processes.",
    ...
    },
    {
        ...
        description: "Developed and maintained Finknow, a Financial Knowledge Graph Query and Analysis Platform using umi (React framework) and Ant Design Pro. Utilized graphin, a React toolkit for graph analysis based on G6, to develop an Equity Network Penetration Graph, enhancing data visualization capabilities.",
    ...
    },
    {
        ...
        description: "Graduated with a Bachelor of Arts in Digital Publishing, securing a GPA of 3.81/4.0. Gained foundational knowledge in digital media and publishing technologies.",
...
export const projectsData = [
    {
        ...
        description: "《古物寻迹》主题沉浸式VR游戏由我主要负责交互设计和代码部分的制作。《古物寻迹》以运河文化为核心切入点，以“解谜”、“罗盘”、“祭坛”、“祈雨”、“击鼓”为主要关键词，运用虚实结合的方式带领玩家穿越古今，探索运河古物背后的神秘故事，让玩家在体验的过程中感受运河文化的独特魅力。",
    ...
    },
    {
        title: "运河行迹游戏",
        title_zh: "运河行迹游戏",
        description: "A collaborative platform enhancing cooperation among Scottish higher education institutions in digital ethics.",
    ...
    },
    {
        ...
        description: "A comprehensive typing speed test application that tracks your overall typing performance. It provides detailed statistics, including total words typed, errors made, and accuracy rate, allowing users to monitor their progress and improve their typing efficiency.",
